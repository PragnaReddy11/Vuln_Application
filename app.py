import os
from flask import Flask, request, redirect, send_from_directory, render_template, url_for, jsonify, session, make_response
import sqlite3
import datetime
import jwt
...
def index():
    ...
    if token: 
        try:
            ...
            if decoded_token and decoded_token["role"] == "admin":
                return render_template('home.html', username=session['username'], is_admin=True)
